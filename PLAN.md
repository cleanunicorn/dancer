...
- [x] M3: permission triage bounded by an operator-set `auto_allow` ceiling, with the thread told what ran unasked
...
| permission triage against the real CLI | `DANCER_LIVE=1 go test ./internal/coordinator -run TestLivePermissionVerdicts` | pass (35s, allow/ask/ask) |
